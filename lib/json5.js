        ...
        switch(typeof obj_part) {
            ...
            case "object":
                if (obj_part === null) {
                    ...
                    var alt_part = checkForCircular(obj_part, holder, key);
                    if (alt_part) {
                        return internalStringify(alt_part, key, isTopLevel);
                    }
                    buffer = "[";
