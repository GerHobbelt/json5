                ...
                while (next()) {
                    if (ch === delim) {
                        ...
                        if (ch === 'u') {
                            ...
                            // escaped CR and CRLF get gobbled up: C-style line continuation.
                        } else if (ch >= '1' && ch <= '7') {
...
JSON5.stringify = function (obj, replacer, space, circularRefHandler) {
    ...
    var getReplacedValueOrUndefined = function(holder, key, isTopLevel) {
        ...
        // If the user-supplied replacer is a function, call it. If it's an array, check objects' string keys for
    ...
    var objStack = [];
    function checkForCircular(obj, holder, key, stringify) {
        for (var i = 0; i < objStack.length; i++) {
            if (objStack[i] === obj) {
                var err = new TypeError("Converting circular structure to JSON");
                if (typeof circularRefHandler === 'function') {
                    return stringify(circularRefHandler(obj, i, objStack, holder, key, err));
                } else {
                    throw err;
                }
            }
    ...
    // Copied from Crockford's implementation of JSON
    // See https://github.com/douglascrockford/JSON-js/blob/e39db4b7e6249f04a195e7dd0840e610cc9e941e/json2.js#L195
    // Begin
    var cx = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
        escapable = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
        escapableES6 = /[\\`\x00-\x08\x0b\x0c\x0e-\x1f]/g,
        ...
        metaES6 = { // table of character substitutions
            '\b': '\\b',        // \b = U+0008
            '\f': '\\f',        // \f = U+000C
            '\v': '\\v',        // \v = U+000B
            '`' : '\\`',
    ...
    function escapeStringES6(string) {
        ...
        //if (lines.length >= 3 || string.length > 20) {
            return '`' + string.replace(escapableES6, function (a) {
                var c = metaES6[a];
                return typeof c === 'string' ?
                    c :
                    '\\u' + ('0000' + a.charCodeAt(0).toString(16)).slice(-4);
    ...
    function internalStringify(holder, key, isTopLevel) {
        ...
        switch(typeof obj_part) {
            ...
            case "string":
                return escapeStringES6(obj_part.toString());

            case "object":
                if (obj_part === null) {
                    return "null";
                } else if (isArray(obj_part)) {
                    return checkForCircular(obj_part, holder, key, function internalStringifyArray(obj_part) {
                        var buffer, res;
                    ...
                    return checkForCircular(obj_part, holder, key, function internalStringifyObject(obj_part) {
                        var buffer;
